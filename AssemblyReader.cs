...
public class AssemblyReader
{
    ...
    public static ICollection<Type> GetInputTypeAttributes(Assembly assembly)
    {
        return new List<Type>(AssemblyReader.GetTypeExtendsFrom(
               assembly,
                typeof(BaseInputAttribute).Name
        ));
    }
    ...
    /*
    public static List<string> GetControlTypeAttributes()
    {
        return (from p in AssemblyReader.GetTypeExtendsFrom(Assembly.GetExecutingAssembly(), nameof(ControlAttribute))
    ...
    {
        return AssemblyReader.GetTypeExtendsFrom(typeof(AuthorizationDataModel).Assembly, nameof(InputTypeAttribute));
    }
    ...
    */
    ...
    public static List<string> GetTypeNamesFromNamespace(string ns)
    {
