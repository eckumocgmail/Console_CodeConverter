...
public interface IServerAppBuilder
{
    public void Run(string program);

    public void Install(string program);
    public void Execute(string program);
    public void Configure(string program);
    public void Deploy(string program);
}



public class ServerAppBuilder:  IServerAppBuilder
{
    public void Install(string program)
    {
...
class Builder
{
    ...
    public void CreateDataModule(string module)
    {
